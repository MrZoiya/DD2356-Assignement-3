...
int main(int argc, char *argv[]){
    ...
    MPI_Sendrecv(&f[2], 1, MPI_DOUBLE, previous, 0,
                 &f[nxn_loc-1], 1, MPI_DOUBLE, next, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
    MPI_Sendrecv(&f[nxn_loc-3], 1, MPI_DOUBLE, next, 0,
                 &f[0], 1, MPI_DOUBLE, previous, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
